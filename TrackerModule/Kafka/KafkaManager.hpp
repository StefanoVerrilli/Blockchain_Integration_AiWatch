...
private:
    ...
    */
     ...
     */
    void setupProducer              (const char* configFile = "configuration_file.ini");
public:
    /**
     * @brief Construct a new Kafka Manager object.
     * @param topic Destination Kafka's topic.
     */
    KafkaManager            (const char* topic, const char* configurationFile = "configuration_file.ini") : topic(topic) {
        setupProducer(configurationFile);
    }
    /**
